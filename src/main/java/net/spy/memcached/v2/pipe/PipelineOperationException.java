...
public final class PipelineOperationException extends ExecutionException {
   ...
   *
   * @param index the index of the failed operation in the pipeline
   */
  public PipelineOperationException(int index, Throwable cause) {
    super("Pipeline operation at index " + index + " failed: " + cause.getMessage(), cause);
    this.index = index;
  }
