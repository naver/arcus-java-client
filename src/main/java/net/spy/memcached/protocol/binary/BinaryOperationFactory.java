...
public class BinaryOperationFactory extends BaseOperationFactory {
  ...
  @Override
  public GetOperation getAndTouch(String key, long expiration, GetOperation.Callback cb) {
    throw new RuntimeException(
            "GetAndTouchOperation is not supported in binary protocol yet.");
  }

  @Override
  public GetsOperation getsAndTouch(String key, long expiration, GetsOperation.Callback cb) {
    throw new RuntimeException(
  ...
  public MutatorOperation mutate(Mutator m, String key, int by,
    ...
    if (exp > Integer.MAX_VALUE) {
      throw new IllegalArgumentException("Binary protocol not support long type expiration.");
    }
  ...
  @Override
  public TouchOperation touch(String key, long expiration, OperationCallback cb) {
    throw new RuntimeException(
